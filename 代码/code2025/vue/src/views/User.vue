   ...
   <div class="search-card">
    ...
    <div class="table-card">
      <el-table 
        ...
        <el-table-column prop="state" label="心理状态"/>
    ...
    <el-dialog 
      ...
      <el-form ref="formRef" :model="data.form" :rules="data.rules" label-width="80px" class="custom-form">
        ...
        <el-form-item prop="state" label="心理状态" >
          <el-input v-model="data.form.state" autocomplete="off" placeholder="请输入心理状态"/>
        </el-form-item>
...
const exportData = () => {
  ...
  let url = `http://localhost:9999/user/export?username=${data.username}`
  + `&name=${data.name}`
  + `&ids=${idsStr}`
